...
-- Set window border for all floating windows
...
-- Set cursor color
-- vim.api.nvim_set_hl(0, 'Cursor', { fg = 'green', bg = 'green' })
        ...
        callback = function(event)
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_inlayHint, event.buf) then
            map('<leader>th', function()
              ...
              print('LSP inlay hints enabled: ' .. tostring(vim.lsp.inlay_hint.is_enabled { bufnr = event.buf }))
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    opts = {
      ...
      keywords = {
        ...
        MARK = { icon = ' ', color = 'hint', alt = { 'MARKER' } },
      },
    },
  },
